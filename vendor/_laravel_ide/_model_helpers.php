...
namespace App\Models {
     ...
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\CallInvite> $invites
     * @property-read int|null $invites_count
     * @method static \Illuminate\Database\Eloquent\Builder<Call>|Call whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Call>|Call whereHostId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Call>|Call whereChannelName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Call>|Call whereDuration($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Call>|Call whereUserId($value)
     ...
     * @property int $id
     * @property-read \App\Models\Call $call
     * @property-read \App\Models\User $inviter
     * @property-read \App\Models\User $invitee
     * @method static \Illuminate\Database\Eloquent\Builder<CallInvite>|CallInvite whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CallInvite>|CallInvite whereCallId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CallInvite>|CallInvite whereInviterId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CallInvite>|CallInvite whereInviteeId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CallInvite>|CallInvite whereStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CallInvite>|CallInvite whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CallInvite>|CallInvite whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<CallInvite>|CallInvite newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<CallInvite>|CallInvite newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<CallInvite>|CallInvite query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class CallInvite extends \Illuminate\Database\Eloquent\Model
    {
        //
    }

    /**
     * App\Models\ChallengeSubmission
     *
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<ChallengeSubmission>|ChallengeSubmission whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ChallengeSubmission>|ChallengeSubmission whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ChallengeSubmission>|ChallengeSubmission whereAnswer($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ChallengeSubmission>|ChallengeSubmission whereIsCorrect($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ChallengeSubmission>|ChallengeSubmission whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ChallengeSubmission>|ChallengeSubmission whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ChallengeSubmission>|ChallengeSubmission newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ChallengeSubmission>|ChallengeSubmission newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ChallengeSubmission>|ChallengeSubmission query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class ChallengeSubmission extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
